package com.liujie.liujieaicode.generator;
...
public class MyBatisCodeGenerator {
    ...
    public static GlobalConfig createGlobalConfig() {
        ...
        globalConfig.getPackageConfig()
                .setBasePackage("com.liujie.liujieaicode.genresult");
        ...
        globalConfig.getJavadocConfig()
                .setAuthor("<a href=\"https://github.com/jklove-kk/liujie-code-ai\">Jklove</a>")
                .setSince("");
        return globalConfig;
    }
}
